...
class SlackBot:
    ...
    async def send_letter_created_notification(
        ...
        blocks: list[dict[str, Any]] = [
            {
                "type": "header",
                "text": {"type": "plain_text", "text": "📬 New Letter Created", "emoji": True},
            },
            {
                "type": "section",
                "text": {
            ...
            {
                "type": "section",
                "text": {"type": "mrkdwn", "text": f"*Items to Pack:*\n{items_display}"},
            },
            {"type": "section", "text": {"type": "mrkdwn", "text": f"*Cost:* ${cost_usd:.2f} USD"}},
        ]
        ...
        blocks.append(
            {
                ...
                "elements": [
                    {
                        "type": "button",
                        "text": {"type": "plain_text", "text": "View in Theseus"},
                        "url": letter_url,
                        "action_id": "view_letter",
                    },
                    {
                        "type": "button",
                        "text": {"type": "plain_text", "text": "View Queue"},
                        "url": queue_url,
                        "action_id": "view_queue",
                    },
                    {
                        "type": "button",
                        "text": {"type": "plain_text", "text": "Mark as Mailed"},
                        "style": "primary",
    ...
    async def update_letter_shipped(
        ...
        blocks: list[dict[str, Any]] = [
            {
                "type": "header",
                "text": {"type": "plain_text", "text": "✅ Letter Mailed", "emoji": True},
            },
            {
                "type": "section",
                "text": {
    ...
    async def send_error_notification(
        self, event_name: str, error_message: str, request_summary: str
    ) -> None:
        """Sends an error notification to the channel."""
        blocks: list[dict[str, Any]] = [
            {
                "type": "header",
                "text": {"type": "plain_text", "text": "🚨 Error Creating Letter", "emoji": True},
            },
            {
                "type": "section",
                "text": {
            ...
            {
                "type": "section",
                "text": {"type": "mrkdwn", "text": f"*Request:* {request_summary}"},
            },
            {
                "type": "section",
                "text": {
                    "type": "mrkdwn",
                    "text": (
                        f"<@{self.jenin_user_id}> - Please investigate"
                        if self.jenin_user_id
                        else "@jenin - Please investigate"
                    ),
                },
            },
        ]
    ...
    async def send_parcel_quote_request(
        ...
        blocks: list[dict[str, Any]] = [
            {
                "type": "header",
                "text": {"type": "plain_text", "text": "📦 Parcel Quote Requested", "emoji": True},
            },
            {
                "type": "section",
                "text": {
            ...
            {
                "type": "section",
                "text": {"type": "mrkdwn", "text": "Please provide a quote for this parcel."},
            },
            {
                "type": "actions",
                "elements": [
                    {
                        "type": "button",
                        "text": {"type": "plain_text", "text": "View Letter"},
                        "url": letter_url,
                        "action_id": "view_letter",
                    }
                ],
    ...
    async def send_server_lifecycle_notification(
        ...
        event_config = {
            ...
            "scheduler_started": {
                "emoji": "⏰",
                "title": "Background Scheduler Started",
                "color": "#4ecdc4",
            },
            "scheduler_stopped": {
                "emoji": "⏹️",
            ...
            "socket_mode_connected": {
                "emoji": "🔌",
                "title": "Slack Socket Mode Connected",
                "color": "#4ecdc4",
            },
            "socket_mode_disconnected": {
                "emoji": "🔌",
                "title": "Slack Socket Mode Disconnected",
                "color": "#ffe66d",
            },
        ...
        config = event_config.get(
            event_type,
            {"emoji": "ℹ️", "title": event_type.replace("_", " ").title(), "color": "#cccccc"},
        )
        ...
        blocks: list[dict[str, Any]] = [
            ...
            {"type": "section", "text": {"type": "mrkdwn", "text": f"*Timestamp:* {timestamp}"}},
        ]
    ...
    async def update_financial_canvas(
        self,
        unpaid_events: list[dict[str, Any]],
        total_due_cents: int,
        total_letters: int,
        ...
        try:
            await self._run_sync(
                self.client.canvases_edit,  # type: ignore[attr-defined]
    ...
    async def send_order_notification(
        ...
        blocks: list[dict[str, Any]] = [
            {
                "type": "header",
                "text": {"type": "plain_text", "text": "📦 New Order Request", "emoji": True},
            },
            {
                "type": "section",
                "text": {
            ...
            {
                "type": "section",
                "text": {"type": "mrkdwn", "text": f"*Order Details:*\n{order_text}"},
            },
            {"type": "divider"},
            {
                "type": "section",
            ...
            {"type": "divider"},
            {
                "type": "context",
                "elements": [
                    {"type": "mrkdwn", "text": "💵 $1 fee per item • Charged to event's HCB"}
                ],
            },
            {
                "type": "actions",
    ...
    async def update_order_fulfilled(
        ...
        fulfilled_str = fulfilled_at.strftime("%Y-%m-%d %I:%M %p") if fulfilled_at else "N/A"
        ...
        blocks: list[dict[str, Any]] = [
            ...
            {
                "type": "section",
                "text": {"type": "mrkdwn", "text": f"*Fulfilled:* {fulfilled_str}"},
            },
        ]
        ...
        if tracking_code:
            blocks.append(
                {
                    "type": "section",
                    "text": {"type": "mrkdwn", "text": f"*Tracking Code:* `{tracking_code}`"},
                }
            )
        ...
        if fulfillment_note:
            blocks.append(
                {
                    "type": "section",
                    "text": {"type": "mrkdwn", "text": f"*Note:* {fulfillment_note}"},
                }
            )
        ...
        blocks.append(
            {
                ...
                "elements": [
                    ...
                    {
                        "type": "button",
                        "text": {"type": "plain_text", "text": "Update Tracking"},
    ...
    async def open_fulfill_order_modal(self, trigger_id: str, order_id: str) -> None:
        """Opens a modal to fulfill an order with optional tracking code and note."""
        view = {
            "type": "modal",
            "callback_id": f"fulfill_order_modal:{order_id}",
            "title": {"type": "plain_text", "text": "Fulfill Order"},
            "submit": {"type": "plain_text", "text": "Fulfill"},
            ...
            "blocks": [
                {
                    ...
                    "label": {"type": "plain_text", "text": "Tracking Code"},
                },
                {
                    "type": "input",
                    ...
                    "element": {
                        ...
                        "multiline": True,
                        "max_length": 500,
                        "placeholder": {"type": "plain_text", "text": "Enter any notes (optional)"},
                    },
        ...
        try:
            await self._run_sync(self.client.views_open, trigger_id=trigger_id, view=view)
    ...
    async def open_update_tracking_modal(
        ...
        view = {
            ...
            "title": {"type": "plain_text", "text": "Update Tracking"},
            ...
            "blocks": [
                {
                    ...
                    "element": {
                        ...
                        "min_length": 1,
                        "max_length": 64,
                        "placeholder": {"type": "plain_text", "text": "Enter new tracking code"},
                    },
                    "label": {"type": "plain_text", "text": "Tracking Code"},
                }
            ],
